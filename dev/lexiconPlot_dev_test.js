...
(function (){
	function lexiconPlotF () {
		...
		var valuesMax = 1;//maximum value of the absolute of each data point, absMax
		...
		this.render = function (issuer) {
			...
			.attr("fill",function(d,i){if(colorMode[0]==="AA"){return aaSymbols[aminoacidsX[data[i]][1]];}else{return binColor;}})
			...
			.attr("stroke-linejoin","round")
			.attr("fill",function(d,i){if(colorMode[0]==="AA"){return aaSymbols[aminoacidsX[data[i]][1]];}else{return phantomColor;}})
		...
		var renderMode = ["line","histogram","glyph"];
	...
	window.lexiconPlot = new lexiconPlotF;
})();
<!--Lexicon-->